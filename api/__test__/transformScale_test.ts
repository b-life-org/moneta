...
Deno.test("transformScale: decimal currencies", async (t) => {
  await t.step(
    "returns a new Moneta object with a new scale and a converted amount",
    () => {
  ...
  await t.step(
    "returns a new Moneta object with a new scale and a converted, rounded down amount",
    () => {
      const d = new Moneta({ amount: 14270n, currency: USD, scale: 2 });
  ...
  await t.step("converts between scales correctly", () => {
    const d = new Moneta({ amount: 333336n, currency: USD, scale: 5 });
  ...
  await t.step("converts from long initial scales correctly", () => {
    const d = new Moneta({ amount: 3333333336n, currency: USD, scale: 9 });
    const snapshot = toSnapshot(transformScale(d, 2));
  ...
  await t.step("uses the provided `halfOdd` divide function", () => {
    const d1 = new Moneta({ amount: 10415n, currency: USD, scale: 3 });
    const d2 = new Moneta({ amount: 10425n, currency: USD, scale: 3 });
  ...
  await t.step("uses the provided `halfEven` divide function", () => {
    const d1 = new Moneta({ amount: 10425n, currency: USD, scale: 3 });
    const d2 = new Moneta({ amount: 10435n, currency: USD, scale: 3 });
  ...
  await t.step("uses the provided `halfDown` divide function", () => {
    const d1 = new Moneta({ amount: 10455n, currency: USD, scale: 3 });
    const d2 = new Moneta({ amount: 10456n, currency: USD, scale: 3 });
  ...
  await t.step("uses the provided `halfUp` divide function", () => {
    const d1 = new Moneta({ amount: 10454n, currency: USD, scale: 3 });
    const d2 = new Moneta({ amount: 10455n, currency: USD, scale: 3 });
...
Deno.test("transformScale: non-decimal currencies", async (t) => {
  ...
  await t.step(
    "returns a new Moneta object with a new scale and a converted, rounded down amount",
    () => {
      const d = new Moneta({ amount: 26n, currency: MGA, scale: 2 });
  ...
  await t.step("uses the provided `up` divide function", () => {
    const d = new Moneta({ amount: 33n, currency: ABC, scale: 2 });
  ...
  await t.step("uses the provided `halfOdd` divide function", () => {
    const d1 = new Moneta({ amount: 33n, currency: ABC, scale: 2 });
    const d2 = new Moneta({ amount: 39n, currency: ABC, scale: 2 });
