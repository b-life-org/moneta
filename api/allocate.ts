...
/**
 * Distribute the amount of a Moneta object across a list of ratios.
 *
 ...
 * @param monetaObject The Moneta object to allocate from.
 * @param ratios The ratios to allocate the amount to.
 * @returns Moneta objects with the allocated amounts.
 ...
 */
export function allocate(...[monetaObject, ratios]: AllocateParams): Moneta[] {
